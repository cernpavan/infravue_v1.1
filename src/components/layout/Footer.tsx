...
const SOCIALS = [
  {
    label: "Instagram",
    href: "https://www.instagram.com/infravue_interiors/",
  ...
  {
    label: "LinkedIn",
    href: "https://www.linkedin.com/company/infravueinteriors",
            ...
            <ul className="space-y-3.5">
              {SERVICES.map(({ label, href }) => (
                <li key={href}>
                  <Link
                    href={href}
                    className="text-sm font-medium text-[#1E3A6A] hover:text-[#A1622C] transition-colors duration-200"
                  >
                    {label}
                  </Link>
                </li>
      ...
      <div className="relative border-t border-[#1E3A6A]/10">
        <div className="max-w-7xl mx-auto px-6 lg:px-20 py-7 flex flex-col sm:flex-row items-center justify-between gap-3">
          ...
          <div className="flex gap-5">
            <Link href="/privacy" className="text-xs font-medium text-[#1E3A6A] hover:text-[#A1622C] transition-colors">
              Privacy Policy
            </Link>
